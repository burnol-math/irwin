...
def _print_umtimeinfo(single, multi, para, wrkrs, M, s):
...
def irwin(b, d, k,
    ...
    if k > 0:
        ...
        # we need the name to be defined when calling para_ukm_partial
    ...
    def ComputeNewCoeffs(m, useparallel, step):
        ...
        if stepindex % 50 == 0:
            ...
            # starttime = time.time()
            # results = para_u0m_partial(((a, M + a,
            #                              PascalRows[a],
            #                              lesgammas,
            #                              lespuissancesded,
            #                              touslescoeffs,
            ...
            starttime = time.time()
            results = para_ukm_partial(((a, M + a,
                                         PascalRows[a],
                                         lesgammas,
                                         lespuissancesded,
                                         touslescoeffs,
            ...
            if useparallel and persistentpara:
                ...
                if showtimes:
                    _print_umtimeinfo(singletime, multitime, useparallel,
                                      maxworkers, M, step)
